...
FORTUNE_KEYWORDS = [
    ...
    # 스패머가 쓰는 '운명/인연/손금' 관련 은어들 및 고의 오타
    "운대", "운때", "누가 들어올지", "언제 들어올지", "나만의 때", "각자만의 흐름", "인연은 있는지",
    "운이 들어와", "운이 들어올지", "생명선", "재물선", "애정선", "두뇌선", "윤세", "운새"
]

# 상담 유도 / 홍보 패턴 확장 (서술어 '보', '봐' 등 대폭 확장)
...
# 단독 스팸 패턴 (거리 제한을 두어 오탐지 완벽 차단 및 인식거리 확장)
STANDALONE_SPAM_PATTERNS = [
    ...
    # 💡 신세 한탄 가장형 패턴: 거리 {0,60} 확장 및 '윤세', '운새', '앞으로의 흐름' 추가
    r"(연애|결혼|이직|회사|직장|승진).{0,60}(운대|운때|나만의\s*때|누가\s*들어올지|언제\s*들어올지|인연은\s*있는지|운.{0,3}흐름|운이\s*들어|앞날을\s*[보봐파]|윤세|운새|앞으로.{0,5}흐름)",
